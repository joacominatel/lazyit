...
| **Machine ID duplicado** | Dos servidores reportaron el mismo machine ID pero hardware distinto: casi siempre una plantilla de VM o imagen dorada clonada con uno adentro. Los dos quedan listados por separado (no se unifica nada) y la notificación nombra la solución. Una notificación por host en conflicto, no una por cada reporte. Enlaza al mapa de topología. |
