...
import { CapabilityGroup } from "./capability-group";
...
import { RoleSegmented } from "./role-segmented";
...
/**
 * Settings → Roles → Role permissions body (client). Extracted from `page.tsx` for the ADR-0067
 * server-prefetch rollout: the page prefetches `permissionConfigKeys.matrix()` so the
 * {@link PermissionsEditor}'s `usePermissionMatrix()` hydrates without a skeleton → fetch waterfall.
 ...
 */
export function PermissionsEditorView() {
  return (
    <AdminGate>
