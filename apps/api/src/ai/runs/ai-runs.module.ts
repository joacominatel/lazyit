 ...
 * the principal loader and the permission resolver (the stream's heartbeat re-check) are global.
 */
@Module({
  imports: [AiRuntimeModule, AiCoreModule],
  controllers: [AiRunsController],
  providers: [AiRunsService, AiRunEventStream, AiStreamPrincipalCheck],
})
