...
- Postgres: `5432`
- Valkey: `6379` (loopback-only in dev)
...
- **Async workers:** decided — **BullMQ on Valkey** with sandboxed processors
  ([[0053-async-workers-bullmq-valkey]]); first job is the async `.docx` import.
