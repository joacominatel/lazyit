...
| [[user-history]] (DEBT-2, #185 / ADR-0058 / ADR-0086) | the event row | `user` | the lowercased `eventType`: `created` · `updated` · `role_changed` · `manager_changed` · `deleted` · `restored` · `password_reset_sent` · `password_reset_by_admin` (local-mode admin reset) |
